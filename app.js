    ...
    document.getElementById("dashContent").innerHTML = `
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;grid-template-rows:auto auto auto;gap:6px;margin-bottom:10px;">
            ...
            <div class="ent-col" style="grid-column:2;grid-row:1;">
                ...
                <div class="ent-pie-legend" style="text-align:center;font-size:9px;color:var(--text-muted);margin-top:4px;"><span style="display:inline-block;width:6px;height:6px;background:#dc2626;vertical-align:middle;margin-right:5px;"></span>Critical&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="display:inline-block;width:6px;height:6px;background:#f97316;vertical-align:middle;margin-right:5px;"></span>High&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="display:inline-block;width:6px;height:6px;background:#3b82f6;vertical-align:middle;margin-right:5px;"></span>Medium&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="display:inline-block;width:6px;height:6px;background:#10b981;vertical-align:middle;margin-right:5px;"></span>Low</div>
            </div>
